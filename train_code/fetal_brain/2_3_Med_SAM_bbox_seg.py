...
if __name__ == '__main__':
    sam_checkpoint = "/home/data/Liuxy/Code/LXY_RPL_SFDA/codesfda/segment_anything/checkpoint/medsam_vit_b.pth"
    model_type = "vit_b"
    device = "cuda:0"
    ...
    fetal_brain_image_init_path = '/home/data/Liuxy/Code/LXY_RPL_SFDA/data/fetal_brain/fetal_brain_norm_with_SAM/1_Corner_point_detection/setting1_NL_trans/source/image/0_image_concat/image_init'
    # ------
    fetal_brain_h5_path = "/home/data/Liuxy/Code/LXY_RPL_SFDA/data/fetal_brain/fetal_brain_norm_with_SAM/3_h5_K_NL_pre_avePL/setting1_TrEq_sm_Dr_Gr_Equal_high_average3/source"
    fetal_brain_SAMbbox_output_image_init_path = '/home/data/Liuxy/Code/LXY_RPL_SFDA/data/fetal_brain/fetal_brain_norm_with_SAM/1_Corner_point_detection/setting1_NL_trans/source/image/1_image_concat_SAM_seg_results/2_add_bbox_promt/10_2_MedSAM_sota'
    fetal_brain_out_png_image_init = "/home/data/Liuxy/Code/LXY_RPL_SFDA/data/fetal_brain/fetal_brain_norm_with_SAM/1_Corner_point_detection/setting1_NL_trans/source/image/1_image_concat_SAM_seg_results/2_add_bbox_promt/10_2_MedSAM_sota/png"
    os.makedirs(fetal_brain_SAMbbox_output_image_init_path, exist_ok=True)
    os.makedirs(fetal_brain_out_png_image_init, exist_ok=True)
    SAM_bbox_mode(fetal_brain_h5_path, fetal_brain_image_init_path, fetal_brain_SAMbbox_output_image_init_path , fetal_brain_out_png_image_init , fetal_brain_image_nii_base_path ) 
