...
parser.add_argument('--root_path', type=str,
                    default='../data/fetal_brain', help='The root_path of Experiment data file ')
parser.add_argument('--exp', type=str,
                    default='1_RPL_selectRPL_fine_tune1', help='model_name')
...
parser.add_argument('--T_fix', type=float,
                    default=0.5, help='a of weight map')
parser.add_argument('--T_fix_name', default="0.5", type=str,
                    help='file name of the a')
parser.add_argument('--batch_size', type=int, default=128,
                    help='batch_size per gpu')
parser.add_argument('--base_lr', type=float,  default=1e-4,
                    help='segmentation network learning rate')
parser.add_argument('--base_lr_name', default="0.0001",
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            UM1_mask = reliability_based_threshold(
                uncertainty_map_batch, threshold)
            ...
            logging.info(
                'iteration %d : total_train_loss : %f, train_loss_ce: %f, train_loss_dice: %f' %
                ...
                if performance > best_performance:
                    ...
                    save_mode_path = os.path.join(snapshot_path,
                                                  'iter_{}_dice_{}.pth'.format(
                                                      iter_num, round(best_performance, 6))) # 保留best_performance的四位小数
...
if __name__ == "__main__":
    ...
    snapshot_path = "../0_RPL_selectRPL/{0:}/{1:}/{2:}/{3:}/{4:}".format(
         args.exp, args.Domain_args, args.max_iterations_name, args.base_lr_name , args.T_fix_name,)
