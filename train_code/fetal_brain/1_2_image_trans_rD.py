...
def objective(gamma, image, target_mean, target_std):
    ...
    return abs(corrected_mean - target_mean)
...
def main():
    ...
    output_dir = '/home/data/Liuxy/Code/LXY_RPL_SFDA/data/fetal_brain/fetal_brain_norm_01/source_transr_0.5'
    output_csv = os.path.join(root_dir, 'source_transr_0.5_case_statistics.csv')
